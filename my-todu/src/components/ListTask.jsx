...
import { markImportant } from '../utils/tuduSlice';
const ListTask = ({text,onComplete}) => {
...
const isCardView=useSelector((state)=> state.toggle.isCardView)
    ...
    const handleMarkImportant = () => {
      ...
      dispatch(markImportant(text));
  };
    return isCardView ? (
      // <div className='  gap-4 w-full '>
      <div className=' w-80 h-36 border border-[#496E4B33] flex justify-between items-center shadow-md rounded-md p-4 m-2'>
  ...
  // </div>
    ...
    <div className='w-full flex items-center justify-between p-2 h-20 border-b border-[#496E4B33]'>
